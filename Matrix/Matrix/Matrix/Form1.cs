    ...
    public partial class Form1 : Form
    {
        ...
        private void sumButton_Click(object sender, EventArgs e)
        {
            ...
            {            
                ...
                Save_func(history + user + " Сложение и вычитание (" + DateTime.Now.ToString("yyyy-MM-dd HH-mm-ss") + ")");
            } 
        }
        ...
        public bool CheckMatrix_2(DataGridView dgv1, DataGridView dgv2)
        {
            ...
            try
            {
                if (dgv1.ColumnCount < 1 || dgv1.RowCount < 1)
        ...
        private void vectorButton_Click(object sender, EventArgs e)
        {
            if (CheckMatrix_2(dgv2_1, dgv2_2))
            {
                ...
                Save_func(history + user + " Векторное умножение (" + DateTime.Now.ToString("yyyy-MM-dd HH-mm-ss") + ")");
            }
        }
        ...
        private void transpButton_Click(object sender, EventArgs e)
        {
            if (CheckMatrix_1(dgv3_1))
            {
                ...
                Save_func(history + user + " Транспонирование (" + DateTime.Now.ToString("yyyy-MM-dd HH-mm-ss") + ")");
            }
        }
        ...
        private void normaButton_Click(object sender, EventArgs e)
        {
            if (CheckMatrix_1(dgv4_1))
            {
                ...
                Save_func(history + user + " Норма (" + DateTime.Now.ToString("yyyy-MM-dd HH-mm-ss") + ")");
            }
        }
        ...
        private void glavnaya_diagonal_Click(object sender, EventArgs e)
        {
            if (CheckMatrix_1(dgv5_1))
            {
                ...
                Save_func(history + user + " Формирование диагональных матриц (" + DateTime.Now.ToString("yyyy-MM-dd HH-mm-ss") + ")");
            }
        }
        ...
        private void opredelitelButton_Click(object sender, EventArgs e)
        {
            ...
            if (CheckMatrix_1(dgv8_1))
            {
                ...
                Save_func(history + user + " Определитель (" + DateTime.Now.ToString("yyyy-MM-dd HH-mm-ss") + ")");
            }
        }
        ...
        private void obratnayaButton_Click(object sender, EventArgs e)
        {
            ...
            if (CheckMatrix_1(dgv6_1))
            {
                ...
                else
                {
                    ...
                    Save_func(history + user + " Обратная матрица (" + DateTime.Now.ToString("yyyy-MM-dd HH-mm-ss") + ")");
                }
            }
        }
        ...
        private void skalyarButton_Click(object sender, EventArgs e)
        {
            ...
            if (CheckMatrix_1(dgv7_1))
            {
                ...
                Save_func(history + user + " Скалярное умножение (" + DateTime.Now.ToString("yyyy-MM-dd HH-mm-ss") + ")");
            }
        }
        ...
        public string Save_func(string file_name)
        {
            string data;
            try
            {
                ...
                switch (selectedIndex)
                {
                    ...
                    default:
                        return "Произошла ошибка при считывании данных.";
                }
            }
            catch (Exception ex)
            {
                return "Произошла ошибка при считывании данных: " + ex.Message;
            }
            ...
            {
                return "Произошла ошибка при записи данных в файл: " + ex.Message;
            }
            return "";
        }
        ...
        public void Load_func(string file_name)
        {
                    ...
                    switch (selectedIndex)
                    {
                        case 0:
                            ...
                            foreach (string line in lines)
                            {
                                ...
                                {
                                    answerResult = line.Substring(line.IndexOf(":") + 1).Trim();
                                }
                            ...
                            rowHeight = dgv1_1.Size.Height / dgv1_1.RowCount;
                            dgv1_1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv1_2.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv1_3.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv1_1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None;
                        ...
                        case 1:
                            ...
                            foreach (string line in lines)
                            {
                                ...
                                else if (line.StartsWith("Результат_матрица"))
                                {
                                    ...
                                    if (currentMatrixIndex == 1)
                                    {
                                        dgv2_1.ColumnCount = size[0];
                                        dgv2_1.RowCount = size[1];
                                    }

                                    if (currentMatrixIndex == 2)
                                    {
                                        dgv2_2.ColumnCount = size[0];
                                        dgv2_2.RowCount = size[1];
                                    }

                                    if (currentMatrixIndex == 3)
                                    {
                                        dgv2_3.ColumnCount = size[0];
                                        dgv2_3.RowCount = size[1];
                                    }
                                ...
                                else if (!string.IsNullOrWhiteSpace(line))
                                {
                                    ...
                                    if (currentMatrixIndex == 1)
                                    {
                                        for (int i = 0; i < matrixValues.Length; i++)
                                        {
                                            dgv2_1[i, temp].Value = matrixValues[i];
                                        }
                                    }
                                    if (currentMatrixIndex == 2)
                                    {
                                        for (int i = 0; i < matrixValues.Length; i++)
                                        {
                                            dgv2_2[i, temp - dgv2_1.RowCount].Value = matrixValues[i];
                                        }
                                    }
                                    if (currentMatrixIndex == 3)
                                    {
                                        for (int i = 0; i < matrixValues.Length; i++)
                                        {
                                            dgv2_3[i, temp - dgv2_1.RowCount - dgv2_2.RowCount].Value = matrixValues[i];
                                        }
                                    }
                                    temp++;
                                }
                            ...
                            size2_1.Text = dgv2_1.ColumnCount.ToString();
                            size2_2.Text = dgv2_1.RowCount.ToString();
                            rowHeight = dgv2_1.Size.Height / dgv2_1.RowCount;
                            rowHeight1 = dgv2_2.Size.Height / dgv2_2.RowCount;
                            dgv2_1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv2_2.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv2_3.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv2_1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None;
                        ...
                        case 2:
                            ...
                            foreach (string line in lines)
                            {
                                ...
                                else if (line.StartsWith("Результат_матрица"))
                                {
                                    ...
                                    if (currentMatrixIndex == 1)
                                    {
                                        dgv3_1.ColumnCount = size[0];
                                        dgv3_1.RowCount = size[1];
                                    }

                                    if (currentMatrixIndex == 2)
                                    {
                                        dgv3_3.ColumnCount = size[0];
                                        dgv3_3.RowCount = size[1];
                                    }
                                ...
                                else if (!string.IsNullOrWhiteSpace(line))
                                {
                                    ...
                                    if (currentMatrixIndex == 1)
                                    {
                                        for (int i = 0; i < matrixValues.Length; i++)
                                        {
                                            dgv3_1[i, temp].Value = matrixValues[i];
                                        }
                                    }
                                    if (currentMatrixIndex == 2)
                                    {
                                        for (int i = 0; i < matrixValues.Length; i++)
                                        {
                                            dgv3_3[i, temp - dgv3_1.RowCount].Value = matrixValues[i];
                                        }
                                    }
                                    temp++;
                                }
                            ...
                            size3_1.Text = dgv3_1.ColumnCount.ToString();
                            size3_2.Text = dgv3_1.RowCount.ToString();
                            rowHeight = dgv3_1.Size.Height / dgv3_1.RowCount;
                            rowHeight1 = dgv3_3.Size.Height / dgv3_3.RowCount;
                            dgv3_1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv3_3.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv3_1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None;
                            dgv3_3.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None;
                            for (int i = 0; i < dgv3_1.RowCount; i++)
                            {
                                dgv3_1.Rows[i].Height = rowHeight - 1;
                            }
                            for (int i = 0; i < dgv3_3.RowCount; i++)
                            {
                                dgv3_3.Rows[i].Height = rowHeight1 - 1;
                            }
                            tabControl1.SelectedIndex = selectedIndex;
                            break;
                        ...
                        case 3:
                            ...
                            foreach (string line in lines)
                            {
                                ...
                                else if (line.StartsWith("Результат_матрица"))
                                {
                                    ...
                                    if (currentMatrixIndex == 1)
                                    {
                                        dgv4_1.ColumnCount = size[0];
                                        dgv4_1.RowCount = size[1];
                                    }
                                ...
                                else if (!string.IsNullOrWhiteSpace(line))
                                {
                                    ...
                                    if (currentMatrixIndex == 1)
                                    {
                                        for (int i = 0; i < matrixValues.Length; i++)
                                        {
                                            dgv4_1[i, temp].Value = matrixValues[i];
                                        }
                                    }
                                    temp++;
                                }
                            }
                            label16.Text = answerResult;
                            size4_1.Text = dgv4_1.ColumnCount.ToString();
                            size4_2.Text = dgv4_1.RowCount.ToString();
                            rowHeight = dgv4_1.Size.Height / dgv4_1.RowCount;
                            dgv4_1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv4_1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None;
                            for (int i = 0; i < dgv4_1.RowCount; i++)
                            {
                        ...
                        case 4:
                            ...
                            foreach (string line in lines)
                            {
                                ...
                                else if (line.StartsWith("Результат_матрица"))
                                {
                                    ...
                                    if (currentMatrixIndex == 1)
                                    {
                                        dgv5_1.ColumnCount = size[0];
                                        dgv5_1.RowCount = size[1];
                                    }

                                    if (currentMatrixIndex == 2)
                                    {
                                        dgv5_3.ColumnCount = size[0];
                                        dgv5_3.RowCount = size[1];
                                    }
                                ...
                                else if (!string.IsNullOrWhiteSpace(line))
                                {
                                    ...
                                    if (currentMatrixIndex == 1)
                                    {
                                        for (int i = 0; i < matrixValues.Length; i++)
                                        {
                                            dgv5_1[i, temp].Value = matrixValues[i];
                                        }
                                    }
                                    if (currentMatrixIndex == 2)
                                    {
                                        for (int i = 0; i < matrixValues.Length; i++)
                                        {
                                            dgv5_3[i, temp - dgv5_1.RowCount].Value = matrixValues[i];
                                        }
                                    }
                                    temp++;
                                }
                            ...
                            size5_1.Text = dgv5_1.ColumnCount.ToString();
                            size5_2.Text = dgv5_1.RowCount.ToString();
                            rowHeight = dgv5_1.Size.Height / dgv5_1.RowCount;
                            dgv5_1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv5_3.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv5_1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None;
                            dgv5_3.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None;
                        ...
                        case 5:
                            ...
                            foreach (string line in lines)
                            {
                                ...
                                else if (line.StartsWith("Результат_матрица"))
                                {
                                    ...
                                    if (currentMatrixIndex == 1)
                                    {
                                        dgv6_1.ColumnCount = size[0];
                                        dgv6_1.RowCount = size[1];
                                    }

                                    if (currentMatrixIndex == 2)
                                    {
                                        dgv6_3.ColumnCount = size[0];
                                        dgv6_3.RowCount = size[1];
                                    }
                                ...
                                else if (!string.IsNullOrWhiteSpace(line))
                                {
                                    ...
                                    if (currentMatrixIndex == 1)
                                    {
                                        for (int i = 0; i < matrixValues.Length; i++)
                                        {
                                            dgv6_1[i, temp].Value = matrixValues[i];
                                        }
                                    }
                                    if (currentMatrixIndex == 2)
                                    {
                                        for (int i = 0; i < matrixValues.Length; i++)
                                        {
                                            dgv6_3[i, temp - dgv6_1.RowCount].Value = matrixValues[i];
                                        }
                                    }
                                    temp++;
                                }
                            ...
                            size6_1.Text = dgv6_1.ColumnCount.ToString();
                            size6_2.Text = dgv6_1.RowCount.ToString();
                            rowHeight = dgv6_1.Size.Height / dgv6_1.RowCount;
                            dgv6_1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv6_3.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv6_1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None;
                            dgv6_3.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None;
                        ...
                        case 6:
                            ...
                            foreach (string line in lines)
                            {
                                ...
                                else if (line.StartsWith("Результат_матрица"))
                                {
                                    ...
                                    if (currentMatrixIndex == 1)
                                    {
                                        dgv7_1.ColumnCount = size[0];
                                        dgv7_1.RowCount = size[1];
                                    }

                                    if (currentMatrixIndex == 2)
                                    {
                                        dgv7_3.ColumnCount = size[0];
                                        dgv7_3.RowCount = size[1];
                                    }
                                ...
                                else if (!string.IsNullOrWhiteSpace(line))
                                {
                                    ...
                                    if (currentMatrixIndex == 1)
                                    {
                                        for (int i = 0; i < matrixValues.Length; i++)
                                        {
                                            dgv7_1[i, temp].Value = matrixValues[i];
                                        }
                                    }
                                    if (currentMatrixIndex == 2)
                                    {
                                        for (int i = 0; i < matrixValues.Length; i++)
                                        {
                                            dgv7_3[i, temp - dgv7_1.RowCount].Value = matrixValues[i];
                                        }
                                    }
                                    temp++;
                                }
                            ...
                            size7_3.Text = variableValue.ToString();
                            size7_1.Text = dgv7_1.ColumnCount.ToString();
                            size7_2.Text = dgv7_1.RowCount.ToString();
                            rowHeight = dgv7_1.Size.Height / dgv7_1.RowCount;
                            dgv7_1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv7_3.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv7_1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None;
                            dgv7_3.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None;
                        ...
                        case 7:
                            ...
                            foreach (string line in lines)
                            {
                                ...
                                else if (line.StartsWith("Результат_матрица"))
                                {
                                    ...
                                    if (currentMatrixIndex == 1)
                                    {
                                        dgv8_1.ColumnCount = size[0];
                                        dgv8_1.RowCount = size[1];
                                    }
                                ...
                                else if (!string.IsNullOrWhiteSpace(line))
                                {
                                    ...
                                    if (currentMatrixIndex == 1)
                                    {
                                        for (int i = 0; i < matrixValues.Length; i++)
                                        {
                                            dgv8_1[i, temp].Value = matrixValues[i];
                                        }
                                    }
                                    temp++;
                                }
                            }
                            label22.Text = answerResult.ToString();
                            size8_1.Text = dgv8_1.ColumnCount.ToString();
                            size8_2.Text = dgv8_1.RowCount.ToString();
                            rowHeight = dgv8_1.Size.Height / dgv8_1.RowCount;
                            dgv8_1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                            dgv8_1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None;
                            for (int i = 0; i < dgv8_1.RowCount; i++)
                            {
        ...
        private void loadButton_Click(object sender, EventArgs e)
        {
            ...
            {
                Load_func(openFileDialog.FileName);
            }
        }
